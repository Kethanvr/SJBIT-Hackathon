// StatusIcon.jsx
// Shows spinner, check, or warning icon based on status
export default function StatusIcon({ status }) {
  if (status === 'processing') {
    return (
      <svg className="w-8 h-8 text-purple-500 animate-spin" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
